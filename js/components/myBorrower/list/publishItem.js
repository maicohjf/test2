        ...
        return (
            <LinearGradient colors={[colors.startColor, index === 0 ? colors.endColor : colors.startColor]}
                ...
                <View style={styles.publish}>
                    ...
                    <Button type="primary" style={item.id==='4'?styles.publishBtnClo:styles.publishBtn} onClick={() => this.props.navigation.navigate('PublishDetail')}>
...
const styles = StyleSheet.create({
    ...
    publishBtnClo: {
        ...
        // width: 60,
        height: 25,
        backgroundColor: Color.gray_DA,
        alignItems: "center",
        justifyContent: 'center',
        borderRadius: 50,
        borderColor: Color.gray_DA,
    },
    btnValue: {
        fontSize: 13,
        color: Color.white,
