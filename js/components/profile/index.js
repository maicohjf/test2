  ...
  render() {
    ...
    return (
        <ScrollView style={{flex: 1, paddingBottom: 10,}}>
          ...
          <View
              style={{height: 144, backgroundColor: '#e5e5e5', alignItems: 'stretch', paddingTop: 0, marginBottom: 10}}>
          ...
          <TouchableOpacity style={styles.bottItem} onPress={() => this.props.navigation.navigate('BankCard')}>
